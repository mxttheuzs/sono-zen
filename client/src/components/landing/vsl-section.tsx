            ...
            <div className="relative rounded-xl overflow-hidden bg-black/50 border border-[var(--accent-blue)]/30">
              <div 
                dangerouslySetInnerHTML={{
                  __html: `
                    <vturb-smartplayer id="vid-6880cd2e24f49ba385264481" style="display: block; margin: 0 auto; width: 100%; "></vturb-smartplayer> 
                    <script type="text/javascript"> 
                      var s=document.createElement("script"); 
                      s.src="https://scripts.converteai.net/565bfa0e-d0fd-494c-b04a-2fc27a3af576/players/6880cd2e24f49ba385264481/v4/player.js", 
                      s.async=!0,
