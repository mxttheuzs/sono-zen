          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[var(--accent-blue)]/5 backdrop-blur-xl border-2 border-[var(--accent-blue)]/40 rounded-3xl overflow-hidden shadow-2xl relative" style={{ boxShadow: '0 0 15px rgba(218, 165, 32, 0.2), 0 0 30px rgba(255, 255, 255, 0.15)' }}>
              ...
              <div className="p-4 sm:p-6 md:p-8">
                ...
                {/* Pricing */}
                <div className="bg-gradient-to-r from-[var(--accent-blue)]/8 to-[var(--warm-accent)]/8 rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 border-2 border-[var(--accent-blue)]/40 backdrop-blur-sm relative" style={{ boxShadow: '0 0 8px rgba(218, 165, 32, 0.12), 0 0 20px rgba(255, 255, 255, 0.16)' }}>
                ...
                {/* Bonuses */}
                <div className="bg-[var(--accent-blue)]/5 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border-2 border-[var(--accent-blue)]/35 backdrop-blur-sm relative" style={{ boxShadow: '0 0 6px rgba(218, 165, 32, 0.08), 0 0 18px rgba(255, 255, 255, 0.14)' }}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-[var(--accent-blue)]/8 to-[var(--warm-accent)]/8 rounded-2xl p-6 sm:p-8 border-2 border-[var(--accent-blue)]/45 backdrop-blur-sm relative" style={{ boxShadow: '0 0 4px rgba(218, 165, 32, 0.06), 0 0 22px rgba(255, 255, 255, 0.18)' }}>
                    <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
                      <div className="flex flex-col items-center text-center p-4 bg-[var(--accent-blue)]/10 border-2 border-[var(--accent-blue)]/35 rounded-xl backdrop-blur-sm hover:bg-[var(--accent-blue)]/15 transition-all duration-300" style={{ boxShadow: '0 0 3px rgba(218, 165, 32, 0.05), 0 0 10px rgba(255, 255, 255, 0.12)' }}>
                      ...
                      <div className="flex flex-col items-center text-center p-4 bg-[var(--warm-accent)]/10 border-2 border-[var(--warm-accent)]/35 rounded-xl backdrop-blur-sm hover:bg-[var(--warm-accent)]/15 transition-all duration-300" style={{ boxShadow: '0 0 3px rgba(218, 165, 32, 0.05), 0 0 10px rgba(255, 255, 255, 0.12)' }}>
