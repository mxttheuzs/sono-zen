      ...
      <section id="preco" className="py-20 bg-[var(--bg-primary)] relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 relative z-10">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[var(--accent-blue)]/5 backdrop-blur-xl border-2 border-[var(--accent-blue)]/40 rounded-3xl overflow-hidden shadow-2xl relative" style={{ boxShadow: '0 0 15px rgba(218, 165, 32, 0.2), 0 0 30px rgba(255, 255, 255, 0.15)' }}>
              ...
              <div className="p-4 sm:p-6 md:p-8">
                ...
                {/* Pricing */}
                <div className="bg-gradient-to-r from-[var(--accent-blue)]/8 to-[var(--warm-accent)]/8 rounded-2xl p-4 sm:p-6 md:p-8 mb-6 sm:mb-8 border-2 border-[var(--accent-blue)]/40 backdrop-blur-sm relative" style={{ boxShadow: '0 0 12px rgba(218, 165, 32, 0.18), 0 0 24px rgba(255, 255, 255, 0.12)' }}>
                ...
                {/* Bonuses */}
                <div className="bg-[var(--accent-blue)]/5 rounded-2xl p-4 sm:p-6 mb-6 sm:mb-8 border-2 border-[var(--accent-blue)]/35 backdrop-blur-sm relative" style={{ boxShadow: '0 0 10px rgba(218, 165, 32, 0.15), 0 0 20px rgba(255, 255, 255, 0.1)' }}>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-gradient-to-r from-[var(--accent-blue)]/8 to-[var(--warm-accent)]/8 rounded-2xl p-6 sm:p-8 border-2 border-[var(--accent-blue)]/45 backdrop-blur-sm relative" style={{ boxShadow: '0 0 14px rgba(218, 165, 32, 0.2), 0 0 28px rgba(255, 255, 255, 0.14)' }}>
                    <div className="grid sm:grid-cols-3 gap-4 sm:gap-6">
                      <div className="flex flex-col items-center text-center p-4 bg-[var(--accent-blue)]/10 border-2 border-[var(--accent-blue)]/35 rounded-xl backdrop-blur-sm hover:bg-[var(--accent-blue)]/15 transition-all duration-300" style={{ boxShadow: '0 0 6px rgba(218, 165, 32, 0.12), 0 0 12px rgba(255, 255, 255, 0.08)' }}>
                      ...
                      <div className="flex flex-col items-center text-center p-4 bg-[var(--warm-accent)]/10 border-2 border-[var(--warm-accent)]/35 rounded-xl backdrop-blur-sm hover:bg-[var(--warm-accent)]/15 transition-all duration-300" style={{ boxShadow: '0 0 6px rgba(218, 165, 32, 0.12), 0 0 12px rgba(255, 255, 255, 0.08)' }}>
